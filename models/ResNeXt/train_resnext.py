# -*- coding: utf-8 -*-
"""
Created on Sun Mar  7 16:15:37 2021
...
def main():
    ...
    net = CifarResNeXt(10,29,10,64,4)
    ...
    net.classifier = nn.Linear(in_channel, 10)
    net.to(device)
